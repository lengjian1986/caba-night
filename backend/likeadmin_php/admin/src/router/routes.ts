...
export const constantRoutes: Array<RouteRecordRaw> = [
    ...
    {
        path: '/shop-portal/login',
        component: () => import('@/views/shop-portal/login.vue')
    },
    {
        path: '/shop-portal/dashboard',
        component: () => import('@/views/shop-portal/dashboard.vue')
    },
    {
        path: '/user',
        component: LAYOUT,
    ...
    {
        path: '/cabakura/dashboard',
        redirect: '/dashboard'
    },
    {
        path: '/cabakura/member/lists',
        redirect: '/member/lists'
    },
    {
        path: '/cabakura/shop/lists',
        redirect: '/shop/lists'
    },
    {
        path: '/cabakura/shop/review',
        redirect: '/shop/review'
    },
    {
        path: '/cabakura/order/lists',
        redirect: '/order/lists'
    },
    {
        path: '/cabakura/support/ticket',
