            ...
            <el-form ref="formRef" class="ls-form" :model="formData" label-width="120px">
                <div class="bg-page flex py-5 mb-10 items-center">
                    <div class="basis-40 flex flex-col justify-center items-center">
                        ...
                        <material-picker
                            ...
                            :limit="1"
                            size="58px"
                            @update:model-value="handleEdit($event, 'avatar')"
                        />
                    </div>
                    <div class="basis-40 flex flex-col justify-center items-center">
                ...
                <el-form-item label="国籍：">
                    ...
                    <popover-input
                        ...
                        @confirm="handleEdit($event, 'nationality')"
                        v-perms="['user.user/edit']"
                    >
                        <el-button type="primary" link>
                            <icon name="el-icon-EditPen" />
                ...
                <el-form-item label="邮编：">
                    ...
                    <popover-input
                        class="ml-[10px]"
                        type="number"
                        @confirm="handleEdit($event, 'postal_code')"
                        v-perms="['user.user/edit']"
                    >
                        <el-button type="primary" link>
                            <icon name="el-icon-EditPen" />
                ...
                <el-form-item label="地址：">
                    ...
                    <popover-input
                        class="ml-[10px]"
                        @confirm="handleEdit($event, 'address')"
                        :limit="255"
                        v-perms="['user.user/edit']"
                    >
                        <el-button type="primary" link>
                ...
                <el-form-item label="建筑名/房间号：">
                    ...
                    <popover-input
                        class="ml-[10px]"
                        @confirm="handleEdit($event, 'building_name')"
                        :limit="255"
                        v-perms="['user.user/edit']"
                    >
                        <el-button type="primary" link>
