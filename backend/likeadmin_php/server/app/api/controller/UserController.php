...
class UserController extends BaseApiController
{
    ...
    public function deleteAccount()
    {
        ...
        $result = UserLogic::deleteAccount($this->userId, $params, $this->userInfo);
        if (!$result) {
            return $this->fail(UserLogic::getError());
        }
        return $this->success('アカウントを削除しました', [], 1, 1);
    }
    ...
    public function saveCabakuraMemberProfile()
    {
        $result = UserLogic::saveCabakuraMemberProfile($this->userId, $this->request->post());
        if (!$result) {
            return $this->fail(UserLogic::getError());
        }
