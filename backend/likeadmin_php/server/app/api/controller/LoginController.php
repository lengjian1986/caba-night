...
class LoginController extends BaseApiController
{
    ...
    public array $notNeedLogin = ['register', 'checkRegisterMobile', 'account', 'logout', 'codeUrl', 'oaLogin',  'mnpLogin', 'getScanCode', 'scanLogin'];
    ...
    {
        (new RegisterValidate())->post()->goCheck('mobile');
        return $this->success('確認しました');
    }
