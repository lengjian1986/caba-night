...
return [
    ...
    // 官网
    'website' => [
        'name' => env('project.web_name', 'Caba Night総合管理画面'), // 网站名称
        ...
        'shop_name' => 'Caba Night総合管理画面', // 商城名称
        ...
        'pc_title' => 'Caba Night総合管理画面', // PC网站标题
    ...
    // 后台管理员token（登录令牌）配置
    'admin_token' => [
        'expire_duration' => 0,//管理后台token过期时长(单位秒），0=无限期
